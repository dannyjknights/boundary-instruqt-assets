...
locals {
  ...
  aws_instance_types = [var.aws_postgres_node_instance_type, var.aws_vault_node_instance_type]
}
...
module "linux_server" {
  ...
  aws_region        = var.aws_region
  aws_ami           = module.aws_infra.aws_ami_ubuntu
  linux_subnet_id   = module.aws_infra.aws_subnet_private_id
  linux_secgroup_id = module.aws_infra.aws_secgroup_private_id
  linux_ssh_keypair = module.aws_infra.aws_ssh_keypair_app_infra
